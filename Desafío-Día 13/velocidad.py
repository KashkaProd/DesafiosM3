def alertas_sobre_promedio(velocidades):
...
if __name__ == "__main__":
    ...
    velocidad = [
        ...
        19, 14, 20, 18, 9, 18, 4, 18, 1,
        3, 4, 2, 14, 23, 19, 23, 9, 18,
        20, 22, 14, 1, 10, 5, 23, 3, 5,
        9, 5, 3, 12, 20, 5, 11, 10, 18,
        10, 14, 5, 23, 20, 23, 21
    ]

    resultado = alertas_sobre_promedio(velocidad)
    print(resultado)
